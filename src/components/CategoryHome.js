...
export default function CategoryHome() {
  return (
    <div>
        <Row className='mt-5'>
            <Col as={Link} to='/category/pc' className='text-decoration-none mb-2' xs={12} md={4}>
            ...
            <Col as={Link} to='/category/laptops' className='text-decoration-none mb-2' xs={12} md={3}>
                <Card className='p-3 border-0 rounded-pill bg-primary text-white home-category-card'>
                    <Card.Title className='m-0 text-center'>Laptop Computers</Card.Title>
                </Card>
            </Col>
            <Col as={Link} to='/category/smartphones' className='text-decoration-none mb-2' xs={12} md={3}>
                <Card className='p-3 border-0 rounded-pill bg-primary text-white home-category-card'>
                    <Card.Title className='m-0 text-center'>Smart Phones</Card.Title>
                </Card>
            </Col>
            <Col as={Link} to='/categories' className='text-decoration-none bg-transparent ms-auto mb-2' xs={12} md={2}>
