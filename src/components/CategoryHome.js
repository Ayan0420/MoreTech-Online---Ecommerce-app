...
export default function CategoryHome() {
  return (
    <div>
        <Row className='mt-5'>
            <Col as={Link} to='/category/pc' className='text-decoration-none' xs={6} md={4}>
            ...
            <Col as={Link} to='/categories' className='text-decoration-none bg-transparent ms-auto' xs={6} md={2}>
