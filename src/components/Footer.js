        ...
        <Container> 
            <Row>
                ...
                <Col md={4} className='d-flex align-items-center justify-content-center'>
                    <p className='small-font mt-md-3 mb-1'>This is a demo site. <Link to={'https://gitlab.com/b247-cabuntucan/s59-s64-capstone-3/capstone-3'} target='_blank'>Get the source</Link></p>
                </Col>
